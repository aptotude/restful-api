 ...
 */
schema.statics.mock = async function(params?: any): Promise<PropertyDocument> {
...
export const Property = mongoose.model<PropertyDocument, PropertyModel>("Property", schema);
